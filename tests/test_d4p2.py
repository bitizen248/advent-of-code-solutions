...
from day_4.part_2 import calculate_total_cards_value
from day_4.part_2 import value_card
...
def test_value_card(card, value):
...
def test_calculate_total_cards_value(lines):
    assert calculate_total_cards_value(lines) == 30
